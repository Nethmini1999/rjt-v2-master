...
@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{url('/admin/settings')}}">Account</a></li>
@endsection
...
<div class="card border-left-danger">
    <div class="card-body">
        {{ Form::open(['url' => '/admin/account', 'id'=>'editRecordFrom']) }}
            <div class="row mt-3">
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-grey-overlay">Update Account Details</button>
                            </div>
                        </div>
                    </div>
                </div>
