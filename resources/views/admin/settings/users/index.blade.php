    ...
    <div class="card-body">
        <div class="row mt-3">
            <div class="col-md-12 text-right">
                <a href="{{url('/admin/settings/add-user')}}" class="btn btn-success btn-grey-overlay btn-icon-split"><span class="icon"><i class="fa fa-plus"></i></span> <span class="text mt-1">Add New User</span></a>
            </div>
        </div>
    ...
    // "deferLoading": 0,
		...
		"columns": [
        {
			...
			render: function (data, type, full, meta) {
                var html ='<a href="{{url('/admin/settings/update-user')}}/'+full.ID +'" class="btn btn-primary btn-xs edit-record" data-id="'+full.ID +'"><i class="fa fa-pencil-alt "></i></a> &nbsp;';
        ...
        { "data": "FirstName", "name":"FirstName", "title": "First Name","width": "15rem",  },
        { "data": "LastName", "name":"LastName", "title": "Last Name","width": "15rem",  },
        { "data": "Email", "name":"Email", "title": "Email","width": "15rem",  },
        { "data": "Designation", "name":"Designation", "title": "Designation","width": "15rem",  },
		]
    });
