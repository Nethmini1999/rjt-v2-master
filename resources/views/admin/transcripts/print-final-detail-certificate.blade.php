...
<li class="breadcrumb-item">Detailed Results Sheet</li>
@endsection
...
<div class="card mb-2">
    <div class="card-body">
        <form>
            <h4 class="text-secondary mb-3 mt-3"><i data-feather="printer" class="mr-0 pb-1"></i> Print Detailed Results Sheet</h4>
        ...
        <div class="row mt-3" >
            ...
            <div class="col-md-2 col-lg-2 mt-1">
                <div class="form-group">
                    ...
                    <button class="btn btn-success btn-grey-overlay btn-icon-split" id="BtnDownload" name="BtnDownload"><span class="icon"><i class="fa fa-print"></i></span> <span class="text">Download Detailed Results Sheet</span></button>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    var table = $('#grid').DataTable({
        ...
        "serverSide": true,
        "ajax": {
                "url": "{{url("/admin/transcripts/final-detail-certificate")}}?type=json",
                "data" : function ( d ) {
                    d.batch = $('#Batch').val();
                    d.search = $('#Search').val();
    ...
    $('#BtnDownload').on('click',function(e){
        ...
        if(students.length > 0) window.location = "{{url('/admin/transcripts/final-detail-certificate-download')}}?students="+students+'&regulation='+regulation;
    });
